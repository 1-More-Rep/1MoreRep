        ...
        {confirmArchive ? (
          <div>
            <p style={{ fontSize: 14, color: 'var(--text-2)', lineHeight: 1.5, marginTop: 0 }}>
              Archive “{name}”? It’s recoverable from Archived routines.
            </p>
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
              <Btn kind="ghost" onClick={() => setConfirmArchive(false)}>Cancel</Btn>
