...
export default function OfflinePage() {
  return (
    <main style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 14, padding: 'var(--screen-pad)', background: 'var(--bg)', textAlign: 'center' }}>
      <div style={{ width: 52, height: 52, borderRadius: 'var(--r)', background: 'var(--accent-strong)', color: 'var(--on-accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800 }}>1R</div>
